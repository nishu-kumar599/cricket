    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-sm-5">
          <div class="logo"><a href="index.php"><img src="<?php $baseUrl = "./";
          echo $baseUrl; ?>images/new/logo.png" alt=""></a></div>
        </div>
        <div class="col-md-10 col-sm-7">
          <nav class="main-nav">
            <ul>
              ...
              <li class="nav-item drop-down"> <a href="contact.php">Contact</a>

              </li>
              <li class="nav-item buy-ticket"> <a href="index2.php">Register/Login</a> </li>
            </ul>
          </nav>
        </div>
      </div>
