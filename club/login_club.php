...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./register_club.php">Register as Club</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="../player/register_player.php">Register as Player </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="#">Club Login </a>
                </li>
                <li class="nav-item active">
    ...
    <div class="container">
        ...
        <h2>Login to your club account</h2>
        <form action="login_club_process.php" method="POST">
